...
function extractNameFromTemplate(value) {
	var str = "Hello, ";	
    return value.slice(str.length, -1);
}
...
function encodeToRot13(str) {
    ...
    for (var i = 0; i < str.length; i++) {	
		...
		if ((charCode >="A".charCodeAt(0) && charCode <= "M".charCodeAt(0)) || (charCode >="a".charCodeAt(0) && charCode <= "m".charCodeAt(0))) {
			res += String.fromCharCode(charCode + 13); 
		} else if ((charCode >="N".charCodeAt(0) && charCode <= "Z".charCodeAt(0)) || (charCode >="n".charCodeAt(0) && charCode <= "z".charCodeAt(0))) {
			res += String.fromCharCode(charCode - 13);
		} else {			
			res += str[i];
		}		
